                    ...
                    foreach ($products_grouped_by_carriers as $data) {
                        foreach ($carrier_count as $id_carrier => $rate) {
                            if (array_key_exists($id_carrier, $data['carrier_list'])) {
								...
								//$package_list[$id_address_delivery][$key][$id_warehouse][$id_carrier]['carrier_list'] =
                                //    array_merge(array_diff($package_list[$id_address_delivery][$key][$id_warehouse][$id_carrier]['carrier_list'], $data['carrier_list']), array_intersect($package_list[$id_address_delivery][$key][$id_warehouse][$id_carrier]['carrier_list'], $data['carrier_list']));
								$package_list[$id_address_delivery][$key][$id_warehouse][$id_carrier]['carrier_list'] =
										array_merge(array_diff($data['carrier_list'], $package_list[$id_address_delivery][$key][$id_warehouse][$id_carrier]['carrier_list']), array_intersect($package_list[$id_address_delivery][$key][$id_warehouse][$id_carrier]['carrier_list'], $data['carrier_list']));
